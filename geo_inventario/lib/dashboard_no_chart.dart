...
class _DashboardPageState extends State<DashboardPage>
                        ...
                        Card(
                          child: Padding(
                            ...
                            child: Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                const Text('Estadísticas por Grupo:',
                                    style:
                                        TextStyle(fontWeight: FontWeight.bold)),
                                const SizedBox(height: 8),
                                ..._getGroupStats().map((stat) => Text(
                                    '${stat['group']}: ${stat['count']} productos')),
                              ],
                            ),
                          ),
                        ),
  ...
  List<Map<String, dynamic>> _getGroupStats() {
